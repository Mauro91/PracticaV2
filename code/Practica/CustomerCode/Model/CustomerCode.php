...
namespace Practica\CustomerCode\Model;




class CustomerCode extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Practica\CustomerCode\Model\ResourceModel\CustomerCode');
    }
}
